...
export default function HomePage() {
  return (
    <div className='home-page w-full landscape:h-[100vh] bg-[#e9ebf0] font-[family-name:var(--font-kanit)] grid place-items-center pt-[1vw] '>
...
{/* why attend */}
<section className='text-[#3b4a6e] flex flex-col items-center landscape:text-[1.2vw] portrait:text-center mt-[4vw] mb-[6vw]'>
