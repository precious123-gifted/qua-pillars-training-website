...
export default function HomePage() {
  return (
    <div className='home-page w-full landscape:h-[100vh] bg-[#dce0ea] font-[family-name:var(--font-kanit)] grid place-items-center pt-[1vw] '>
...
<h1 className='landscape:text-[2vw] portrait:text-[6vw] '>Evidence-Based Medicines Research & <span className='bg-[#283b63]'>Pharmacovigilance Training</span></h1>
<p className='landscape:text-[1.4vw] portrait:text-[3vw] portrait:bg-[#283b63]'>1-3 July 2025</p>
<p className='landscape:text-[1.3vw] portrait:text-[3vw] portrait:bg-[#283b63]'>Lagos, Nigeria</p>
