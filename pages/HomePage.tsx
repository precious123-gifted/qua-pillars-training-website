...
className='flex justify-center mt-2  h-[60vh]  text-[#b8c2d8] rounded-sm portrait:space-x-4'>

<div className="writeup flex flex-col space-y-2  items-center portrait:text-center w-full">
<h1 className='landscape:text-[3vw] portrait:text-[6vw] bg-[#283b63] w-full h-[6vw] portrait:h-[30vw] text-center mb-[6vw] portrait:mb-[10vw]'>Evidence-Based Medicines Research & Pharmacovigilance Training</h1>
<p className='landscape:text-[2vw] portrait:text-[4.2vw] text-[#283b63]'>1-3 July 2025</p>
<p className='landscape:text-[2vw] portrait:text-[4.2vw] text-[#283b63]'>Lagos, Nigeria</p>
